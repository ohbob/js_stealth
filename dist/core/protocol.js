...
const EVENT_ARG_TYPES = [
    ...
    (buf, offset) => unpackInt32(buf, offset), // 2 - _int
    unpackUInt16, // 3 - _ushort
    (buf, offset) => unpackInt16(buf, offset), // 4 - _short
    unpackUInt8, // 5 - _ubyte
    (buf, offset) => unpackInt8(buf, offset), // 6 - _byte
    unpackBool, // 7 - _bool
];
export class Protocol extends EventEmitter {
    ...
    pendingPromises;
    callbacks;
    _handlers = []; // Queue for event handlers (like Python)
    _backgroundPollLoop = null;
    _pollInterval = null;
    constructor(socket) {
        super();
        this.socket = socket;
    ...
    async waitForResult(id, timeout = 3000) {
