...
export declare function Ground(): any;
...
export declare function importStealth(scope?: typeof globalThis): Promise<void>;
export declare function run(fn: any): Promise<void>;
export declare function sync(): any;
export declare function createSyncContext(): NodeJS.Module;
export declare function enableBlocking(): void;
